...
void IbisAPI::RemoveObject( SceneObject * object ) { m_sceneManager->RemoveObject( object ); }

void IbisAPI::RemoveAllChildrenObjects( SceneObject * obj ) { m_sceneManager->RemoveAllChildrenObjects( obj ); }

SceneObject * IbisAPI::GetCurrentObject() { return m_sceneManager->GetCurrentObject(); }

void IbisAPI::SetCurrentObject( SceneObject * cur ) { m_sceneManager->SetCurrentObject( cur ); }

SceneObject * IbisAPI::GetObjectByID( int id ) { return m_sceneManager->GetObjectByID( id ); }

void IbisAPI::RemoveObjectByID( int id ) { m_sceneManager->RemoveObjectById( id ); }

SceneObject * IbisAPI::GetSceneRoot() { return m_sceneManager->GetSceneRoot(); }

PointerObject * IbisAPI::GetNavigationPointerObject() { return m_sceneManager->GetNavigationPointerObject(); }

int IbisAPI::GetNumberOfUserObjects() { return m_sceneManager->GetNumberOfUserObjects(); }

void IbisAPI::GetAllUserObjects( QList<SceneObject *> & list ) { m_sceneManager->GetAllUserObjects( list ); }

ImageObject * IbisAPI::GetReferenceDataObject() { return m_sceneManager->GetReferenceDataObject(); }

void IbisAPI::GetAllImageObjects( QList<ImageObject *> & objects ) { m_sceneManager->GetAllImageObjects( objects ); }
...
const QList<SceneObject *> & IbisAPI::GetAllObjects() { return m_sceneManager->GetAllObjects(); }
...
void IbisAPI::GetAllCameraObjects( QList<CameraObject *> & all ) { return m_sceneManager->GetAllCameraObjects( all ); }

View * IbisAPI::GetViewByID( int id ) { return m_sceneManager->GetViewByID( id ); }

View * IbisAPI::GetMain3DView() { return m_sceneManager->GetMain3DView(); }

View * IbisAPI::GetMainCoronalView() { return m_sceneManager->GetMainCoronalView(); }

View * IbisAPI::GetMainSagittalView() { return m_sceneManager->GetMainSagittalView(); }
View * IbisAPI::GetMainTransverseView() { return m_sceneManager->GetMainTransverseView(); }

QMap<View *, int> IbisAPI::GetAllViews() { return m_sceneManager->GetAllViews(); }

void IbisAPI::SetRenderingEnabled( bool enable ) { m_sceneManager->SetRenderingEnabled( enable ); }

double * IbisAPI::GetViewBackgroundColor() { return m_sceneManager->GetViewBackgroundColor(); }

double * IbisAPI::GetView3DBackgroundColor() { return m_sceneManager->GetView3DBackgroundColor(); }

void IbisAPI::SetViewBackgroundColor( double * color ) { m_sceneManager->SetViewBackgroundColor( color ); }

void IbisAPI::SetView3DBackgroundColor( double * color ) { m_sceneManager->SetView3DBackgroundColor( color ); }
...
void IbisAPI::NewScene() { m_sceneManager->NewScene(); }

void IbisAPI::LoadScene( QString & filename, bool interactive ) { m_sceneManager->LoadScene( filename, interactive ); }

bool IbisAPI::IsLoadingScene() { return m_sceneManager->IsLoadingScene(); }

const QString IbisAPI::GetSceneDirectory() { return m_sceneManager->GetSceneDirectory(); }
...
void IbisAPI::SetCursorWorldPosition( double * pos ) { m_sceneManager->SetCursorWorldPosition( pos ); }

// slots
void IbisAPI::ObjectAddedSlot( int id ) { emit ObjectAdded( id ); }

void IbisAPI::ObjectRemovedSlot( int id ) { emit ObjectRemoved( id ); }

void IbisAPI::ReferenceTransformChangedSlot() { emit ReferenceTransformChanged(); }

void IbisAPI::ReferenceObjectChangedSlot() { emit ReferenceObjectChanged(); }

void IbisAPI::CursorPositionChangedSlot() { emit CursorPositionChanged(); }
...
void IbisAPI::StopProgress( QProgressDialog * progressDialog ) { m_application->StopProgress( progressDialog ); }
...
void IbisAPI::Warning( const QString & title, const QString & text ) { m_application->Warning( title, text ); }

bool IbisAPI::IsViewerOnly() { return m_application->IsViewerOnly(); }

QString IbisAPI::GetWorkingDirectory() { return m_application->GetSettings()->WorkingDirectory; }

QString IbisAPI::GetConfigDirectory() { return m_application->GetConfigDirectory(); }
...
QString IbisAPI::GetGitHashShort() { return m_application->GetGitHashShort(); }
...
void IbisAPI::AddGlobalEventHandler( GlobalEventHandler * h ) { m_application->AddGlobalEventHandler( h ); }

void IbisAPI::RemoveGlobalEventHandler( GlobalEventHandler * h ) { m_application->RemoveGlobalEventHandler( h ); }
...
void IbisAPI::OpenFiles( OpenFileParams * params, bool addToScene ) { m_application->OpenFiles( params, addToScene ); }
...
void IbisAPI::AddBottomWidget( QWidget * w ) { m_application->AddBottomWidget( w ); }

void IbisAPI::RemoveBottomWidget( QWidget * w ) { m_application->RemoveBottomWidget( w ); }
...
IbisPreferences * IbisAPI::GetIbisPreferences() { return m_application->GetIbisPreferences(); }
